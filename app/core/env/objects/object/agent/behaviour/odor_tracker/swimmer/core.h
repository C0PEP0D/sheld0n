#ifndef C0P_CORE_ENV_OBJECTS_OBJECT_AGENT_BEHAVIOUR_ODOR_TRACKER_SWIMMER_CORE_H
#define C0P_CORE_ENV_OBJECTS_OBJECT_AGENT_BEHAVIOUR_ODOR_TRACKER_SWIMMER_CORE_H
#pragma once

// app includes
#include "core/env/objects/core.h"
#include "core/env/objects/object/agent/behaviour/odor_tracker/swimmer/prop.h"
...
class AgentBehaviourOdorTrackerSwimmer : public sl0::sa0::Behaviour<AgentActiveStep> {
    public:
    ...
    public:
        AgentBehaviourOdorTrackerSwimmer(std::shared_ptr<Objects> sObjects) : sensorPosition(sObjects) {
        }
    public:
