#ifndef C0P_CORE_ENV_OBJECTS_OBJECT_AGENT_BEHAVIOUR_NAVIGATOR_INERTIAL_SWIMMER_CORE_H
#define C0P_CORE_ENV_OBJECTS_OBJECT_AGENT_BEHAVIOUR_NAVIGATOR_INERTIAL_SWIMMER_CORE_H
#pragma once

// app includes
#include "core/env/objects/core.h"
#include "core/env/objects/object/agent/behaviour/navigator/inertial_swimmer/prop.h"
...
class AgentBehaviourNavigatorInertialSwimmer : public sl0::sa0::Behaviour<AgentActiveStep> {
    public:
    ...
    public:
        AgentBehaviourNavigatorInertialSwimmer(std::shared_ptr<Objects> sObjects) : sensorDirection(sObjects) {
        }
    public:
    ...
    public:
        void operator()(const double* pState, const double& t, const AgentActiveStep& stepActive) const override {
            ...
            stepActive.sStepInertialSwim->velocity = swimmingDirection * behaviourVelocity(pState, t, stepActive, direction, velocityGradients, swimmingDirection) * stepActive.parameters.velocity.norm();
        }
};
