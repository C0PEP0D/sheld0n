#ifndef C0P_PARAM_OBJECTS_OBJECT_POS_GROUP_BOX_PARAMETERS_H
#define C0P_PARAM_OBJECTS_OBJECT_POS_GROUP_BOX_PARAMETERS_H
#pragma once
...
struct InitObjectPosGroupBoxParameters {
    // Origin of the box
