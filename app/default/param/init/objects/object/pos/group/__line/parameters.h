#ifndef C0P_PARAM_OBJECTS_OBJECT_POS_GROUP_LINE_PARAMETERS_H
#define C0P_PARAM_OBJECTS_OBJECT_POS_GROUP_LINE_PARAMETERS_H
#pragma once
...
struct InitObjectPosGroupLineParameters {
    // Origin of the line
