#ifndef C0P_PARAM_OBJECTS_OBJECT_POS_PAIR_DISTANCE_PARAMETERS_H
#define C0P_PARAM_OBJECTS_OBJECT_POS_PAIR_DISTANCE_PARAMETERS_H
#pragma once
...
struct InitObjectPosPairDistanceParameters {
