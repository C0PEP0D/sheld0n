#ifndef C0P_PARAM_INIT_OBJECTS_OBJECT_POS_PAIR_BOTH_A_PASSIVE_POSITION_BOX_PARAMETERS_H
#define C0P_PARAM_INIT_OBJECTS_OBJECT_POS_PAIR_BOTH_A_PASSIVE_POSITION_BOX_PARAMETERS_H
#pragma once
...
struct InitObjectPosPairBothAPassivePositionBoxParameters {
    // Center of the box
