#ifndef C0P_PARAM_INIT_OBJECTS_OBJECT_POS_PAIR_B_B_PASSIVE_POSITION_BOX_PARAMETERS_H
#define C0P_PARAM_INIT_OBJECTS_OBJECT_POS_PAIR_B_B_PASSIVE_POSITION_BOX_PARAMETERS_H
#pragma once
...
struct InitObjectPosPairBBPassivePositionBoxParameters {
    // Center of the box
