#ifndef C0P_PARAM_INIT_OBJECTS_OBJECT_POS_PASSIVE_POSITION_BOX_PARAMETERS_H
#define C0P_PARAM_INIT_OBJECTS_OBJECT_POS_PASSIVE_POSITION_BOX_PARAMETERS_H
#pragma once
...
struct InitObjectPosPassivePositionBoxParameters {
    // Center of the box
