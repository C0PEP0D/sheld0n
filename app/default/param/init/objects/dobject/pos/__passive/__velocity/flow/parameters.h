#ifndef C0P_PARAM_INIT_OBJECTS_DOBJECT_POS_PASSIVE_VELOCITY_FLOW_PARAMETERS_H
#define C0P_PARAM_INIT_OBJECTS_DOBJECT_POS_PASSIVE_VELOCITY_FLOW_PARAMETERS_H
#pragma once
...
struct InitDobjectPosPassiveVelocityFlowParameters {
