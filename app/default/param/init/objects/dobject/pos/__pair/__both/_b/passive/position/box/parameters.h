#ifndef C0P_PARAM_INIT_OBJECTS_DOBJECT_POS_PAIR_BOTH_B_PASSIVE_POSITION_BOX_PARAMETERS_H
#define C0P_PARAM_INIT_OBJECTS_DOBJECT_POS_PAIR_BOTH_B_PASSIVE_POSITION_BOX_PARAMETERS_H
#pragma once
...
struct InitDobjectPosPairBothBPassivePositionBoxParameters {
    // Center of the box
