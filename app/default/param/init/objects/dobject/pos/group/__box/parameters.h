#ifndef C0P_PARAM_OBJECTS_DOBJECT_POS_GROUP_BOX_PARAMETERS_H
#define C0P_PARAM_OBJECTS_DOBJECT_POS_GROUP_BOX_PARAMETERS_H
#pragma once
...
struct InitDobjectPosGroupBoxParameters {
    // Origin of the box
