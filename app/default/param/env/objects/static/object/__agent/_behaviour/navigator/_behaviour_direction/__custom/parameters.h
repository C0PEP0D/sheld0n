#ifndef C0P_PARAM_OBJECTS_OBJECT_AGENT_BEHAVIOUR_NAVIGATOR_BEHAVIOUR_DIRECTION_CUSTOM_PARAMETERS_H
#define C0P_PARAM_OBJECTS_OBJECT_AGENT_BEHAVIOUR_NAVIGATOR_BEHAVIOUR_DIRECTION_CUSTOM_PARAMETERS_H
#pragma once
...
struct ObjectAgentBehaviourNavigatorBehaviourDirectionCustomParameters {
	...
	TypeSpaceVector operator()(const double* pState, const double& t, const AgentActiveStep&  stepActive, const TypeSpaceVector& direction, const TypeSpaceMatrix& velocityGradients) const {
		...
		const TypeSpaceVector targetDirection = direction;
