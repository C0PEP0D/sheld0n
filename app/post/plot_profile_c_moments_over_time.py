...
def main(passive_scalar_list, input_color_list, step):
    ...
    for equation_index, equation_name in enumerate(passive_scalar_list):
        ...
        plt.scatter(time_array[::step], q[::step], color=color_list[equation_index], marker=marker_list[equation_index % len(marker_list)], label=equation_name)
    plt.xlabel(r'$t$')
    plt.ylabel(r'$q$')
    plt.legend(frameon=True)
    plt.tight_layout()
    plt.savefig("profile_q_over_time.pdf") 
    ...
    for equation_index, equation_name in enumerate(passive_scalar_list):
        ...
        plt.scatter(time_array[::step], mean[::step], color=color_list[equation_index], marker=marker_list[equation_index % len(marker_list)], label=equation_name)
    plt.xlabel(r'$t$')
    plt.ylabel(r'$\mu$')
    plt.legend(frameon=True)
    plt.tight_layout()
    plt.savefig("profile_mu_over_time.pdf") 
    ...
    for equation_index, equation_name in enumerate(passive_scalar_list):
        ...
        plt.scatter(time_array[::step], std[::step], color=color_list[equation_index], marker=marker_list[equation_index % len(marker_list)], label=equation_name)
    plt.xlabel(r'$t$')
    plt.ylabel(r'$\sigma$')
    plt.legend(frameon=True)
    plt.tight_layout()
    plt.savefig("profile_sigma_over_time.pdf") 
