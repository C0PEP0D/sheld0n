...
def set_flow():
    ...
    # params
    os.system('./.cli_set_parameter param cLength "2.0 * M_PI"')
    os.system('./.cli_set_parameter param cTime "2.0 * M_PI"')
...
def set_solutions():
    ...
    os.system('./.cli_set_parameter param/solutions/passive_scalar_blobs SplitSizeFactor "5e-1"')
    ...
    os.system('./.cli_set_parameter param/solutions/odor_emitters SourceReactionTime "1.0/128.0"')
    ## odor trackers
...
def main():
    ...
    shutil.copy(code_dir + "/app/post/generate_scene_2d.py", "post_process/generate_scene_2d.py")
