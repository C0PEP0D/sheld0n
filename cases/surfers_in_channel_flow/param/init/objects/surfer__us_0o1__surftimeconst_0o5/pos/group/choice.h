...
namespace c0p {
    ...
    using InitSurferUs0O1Surftimeconst0O5PosGroup = InitInitGroupAll<InitSurferUs0O1Surftimeconst0O5PosGroupAllParameters, TypeSurferUs0O1Surftimeconst0O5Step, InitSurferUs0O1Surftimeconst0O5PosGroupMember>;
}
