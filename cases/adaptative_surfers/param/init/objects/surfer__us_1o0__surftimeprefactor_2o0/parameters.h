...
struct InitSurferUs1O0Surftimeprefactor2O0Parameters {
    ...
    // make data
    std::vector<std::shared_ptr<InitInitInit<TypeSurferUs1O0Surftimeprefactor2O0Step>>> data;
    InitSurferUs1O0Surftimeprefactor2O0Parameters(std::shared_ptr<TypeSurferUs1O0Surftimeprefactor2O0Step> sSurferUs1O0Surftimeprefactor2O0Step) {
        ...
        data.push_back(std::make_shared<InitSurferUs1O0Surftimeprefactor2O0Pos<TypeSurferUs1O0Surftimeprefactor2O0Step>>(sSurferUs1O0Surftimeprefactor2O0Step));
        // FLAG: MAKE INIT END
    }
};
