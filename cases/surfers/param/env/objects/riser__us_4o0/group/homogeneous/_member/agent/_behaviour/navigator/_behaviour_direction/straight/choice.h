...
namespace c0p {
    ...
    using RiserUs4O0GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourDirectionStraight = AgentBehaviourNavigatorBehaviourDirectionStraight<RiserUs4O0GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourDirectionStraightParameters, RiserUs4O0GroupHomogeneousMemberAgentActiveStep, RiserUs4O0GroupHomogeneousMemberAgentBehaviourSensorDirection<RiserUs4O0GroupHomogeneousMemberAgentActiveStep>>;
}
