...
namespace c0p {
    ...
    using RiserUs4O0GroupHomogeneousMemberAgentBehaviourNavigator = AgentBehaviourNavigatorSwimmer<RiserUs4O0GroupHomogeneousMemberAgentBehaviourNavigatorSwimmerParameters, RiserUs4O0GroupHomogeneousMemberAgentActiveStep, RiserUs4O0GroupHomogeneousMemberAgentBehaviourSensorDirection<RiserUs4O0GroupHomogeneousMemberAgentActiveStep>, RiserUs4O0GroupHomogeneousMemberAgentBehaviourSensorVelocityGradients<RiserUs4O0GroupHomogeneousMemberAgentActiveStep>, RiserUs4O0GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourDirection<RiserUs4O0GroupHomogeneousMemberAgentActiveStep>, RiserUs4O0GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourVelocity<RiserUs4O0GroupHomogeneousMemberAgentActiveStep>>;
}
