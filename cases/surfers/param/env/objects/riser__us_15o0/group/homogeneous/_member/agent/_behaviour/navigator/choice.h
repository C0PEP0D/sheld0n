...
namespace c0p {
    ...
    using RiserUs15O0GroupHomogeneousMemberAgentBehaviourNavigator = AgentBehaviourNavigatorSwimmer<RiserUs15O0GroupHomogeneousMemberAgentBehaviourNavigatorSwimmerParameters, RiserUs15O0GroupHomogeneousMemberAgentActiveStep, RiserUs15O0GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourDirection<RiserUs15O0GroupHomogeneousMemberAgentActiveStep>, RiserUs15O0GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourVelocity<RiserUs15O0GroupHomogeneousMemberAgentActiveStep>>;
}
