#ifndef C0P_PARAM_OBJECTS_SURFER__US_2O0__SURFTIMECONST_4O0_GROUP_HOMOGENEOUS_MEMBER_AGENT_BEHAVIOUR_NAVIGATOR_BEHAVIOUR_VELOCITY_CONST_CHOICE_H
#define C0P_PARAM_OBJECTS_SURFER__US_2O0__SURFTIMECONST_4O0_GROUP_HOMOGENEOUS_MEMBER_AGENT_BEHAVIOUR_NAVIGATOR_BEHAVIOUR_VELOCITY_CONST_CHOICE_H
#pragma once
...
#include "param/env/objects/surfer__us_2o0__surftimeconst_4o0/group/homogeneous/_member/agent/_behaviour/navigator/_behaviour_velocity/const/parameters.h"
namespace c0p {
    template<typename SurferUs2O0Surftimeconst4O0GroupHomogeneousMemberAgentActiveStep>
    using SurferUs2O0Surftimeconst4O0GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourVelocityConst = AgentBehaviourNavigatorBehaviourVelocityConst<SurferUs2O0Surftimeconst4O0GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourVelocityConstParameters, SurferUs2O0Surftimeconst4O0GroupHomogeneousMemberAgentActiveStep, SurferUs2O0Surftimeconst4O0GroupHomogeneousMemberAgentBehaviourSensorDirection<SurferUs2O0Surftimeconst4O0GroupHomogeneousMemberAgentActiveStep>, SurferUs2O0Surftimeconst4O0GroupHomogeneousMemberAgentBehaviourSensorVelocityGradients<SurferUs2O0Surftimeconst4O0GroupHomogeneousMemberAgentActiveStep>>;
}
