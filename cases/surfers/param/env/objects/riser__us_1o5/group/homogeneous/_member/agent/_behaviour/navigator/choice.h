...
namespace c0p {
    ...
    using RiserUs1O5GroupHomogeneousMemberAgentBehaviourNavigator = AgentBehaviourNavigatorSwimmer<RiserUs1O5GroupHomogeneousMemberAgentBehaviourNavigatorSwimmerParameters, RiserUs1O5GroupHomogeneousMemberAgentActiveStep, RiserUs1O5GroupHomogeneousMemberAgentBehaviourSensorDirection<RiserUs1O5GroupHomogeneousMemberAgentActiveStep>, RiserUs1O5GroupHomogeneousMemberAgentBehaviourSensorVelocityGradients<RiserUs1O5GroupHomogeneousMemberAgentActiveStep>, RiserUs1O5GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourDirection<RiserUs1O5GroupHomogeneousMemberAgentActiveStep>, RiserUs1O5GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourVelocity<RiserUs1O5GroupHomogeneousMemberAgentActiveStep>>;
}
