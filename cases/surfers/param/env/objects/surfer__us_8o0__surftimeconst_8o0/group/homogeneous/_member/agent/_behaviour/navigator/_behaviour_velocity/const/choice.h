#ifndef C0P_PARAM_OBJECTS_SURFER__US_8O0__SURFTIMECONST_8O0_GROUP_HOMOGENEOUS_MEMBER_AGENT_BEHAVIOUR_NAVIGATOR_BEHAVIOUR_VELOCITY_CONST_CHOICE_H
#define C0P_PARAM_OBJECTS_SURFER__US_8O0__SURFTIMECONST_8O0_GROUP_HOMOGENEOUS_MEMBER_AGENT_BEHAVIOUR_NAVIGATOR_BEHAVIOUR_VELOCITY_CONST_CHOICE_H
#pragma once
...
#include "param/env/objects/surfer__us_8o0__surftimeconst_8o0/group/homogeneous/_member/agent/_behaviour/navigator/_behaviour_velocity/const/parameters.h"
namespace c0p {
    template<typename SurferUs8O0Surftimeconst8O0GroupHomogeneousMemberAgentActiveStep>
    using SurferUs8O0Surftimeconst8O0GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourVelocityConst = AgentBehaviourNavigatorBehaviourVelocityConst<SurferUs8O0Surftimeconst8O0GroupHomogeneousMemberAgentBehaviourNavigatorBehaviourVelocityConstParameters, SurferUs8O0Surftimeconst8O0GroupHomogeneousMemberAgentActiveStep, SurferUs8O0Surftimeconst8O0GroupHomogeneousMemberAgentBehaviourSensorDirection<SurferUs8O0Surftimeconst8O0GroupHomogeneousMemberAgentActiveStep>, SurferUs8O0Surftimeconst8O0GroupHomogeneousMemberAgentBehaviourSensorVelocityGradients<SurferUs8O0Surftimeconst8O0GroupHomogeneousMemberAgentActiveStep>>;
}
