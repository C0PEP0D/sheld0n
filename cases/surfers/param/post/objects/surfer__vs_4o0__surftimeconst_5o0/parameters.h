...
#include "param/post/objects/surfer__vs_4o0__surftimeconst_5o0/dir/choice.h"
...
struct PostSurferVs4O0Surftimeconst5O0Parameters {
    ...
    PostSurferVs4O0Surftimeconst5O0Parameters(std::shared_ptr<TypeObjectStep> sObjectStep) {
        ...
        data.push_back(std::make_shared<PostSurferVs4O0Surftimeconst5O0Dir<TypeObjectStep>>(sObjectStep));
        // FLAG: MAKE POST END
    }
};
