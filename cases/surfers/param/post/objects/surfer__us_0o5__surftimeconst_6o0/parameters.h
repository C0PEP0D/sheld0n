#ifndef C0P_PARAM_POST_OBJECTS_SURFER__US_0O5__SURFTIMECONST_6O0_PARAMETERS_H
#define C0P_PARAM_POST_OBJECTS_SURFER__US_0O5__SURFTIMECONST_6O0_PARAMETERS_H
#pragma once
...
// SurferUs0O5Surftimeconst6O0 post processing parameters
template<typename TypeSurferUs0O5Surftimeconst6O0Step>
struct PostSurferUs0O5Surftimeconst6O0Parameters {
    std::string name = "surfer__us_0o5__surftimeconst_6o0";
    // make data
    std::vector<std::shared_ptr<PostPostPost<TypeSurferUs0O5Surftimeconst6O0Step>>> data;
    PostSurferUs0O5Surftimeconst6O0Parameters(std::shared_ptr<TypeSurferUs0O5Surftimeconst6O0Step> sSurferUs0O5Surftimeconst6O0Step) {
