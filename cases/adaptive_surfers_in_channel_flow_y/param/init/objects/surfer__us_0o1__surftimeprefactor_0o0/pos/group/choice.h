...
namespace c0p {
    ...
    using InitSurferUs0O1Surftimeprefactor0O0PosGroup = InitInitGroupAll<InitSurferUs0O1Surftimeprefactor0O0PosGroupAllParameters, TypeObjectStep, InitSurferUs0O1Surftimeprefactor0O0PosGroupMember>;
}
