...
struct InitSurferUs1O0Surftimeprefactor3O0Parameters {
    ...
    // make data
    std::vector<std::shared_ptr<InitInitInitStatic<TypeSurferUs1O0Surftimeprefactor3O0Step>>> sInits;
    InitSurferUs1O0Surftimeprefactor3O0Parameters(std::shared_ptr<TypeSurferUs1O0Surftimeprefactor3O0Step> sSurferUs1O0Surftimeprefactor3O0Step) {
        ...
        sInits.push_back(std::make_shared<InitSurferUs1O0Surftimeprefactor3O0Pos<TypeSurferUs1O0Surftimeprefactor3O0Step>>(sSurferUs1O0Surftimeprefactor3O0Step));
        // FLAG: MAKE INIT END
    }
};
