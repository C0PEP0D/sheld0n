...
#include "param/post/objects/surfer__us_0o1__surftimeprefactor_1o25/pos/choice.h"
...
struct PostSurferUs0O1Surftimeprefactor1O25Parameters {
    ...
    PostSurferUs0O1Surftimeprefactor1O25Parameters(std::shared_ptr<TypeObjectStep> sObjectStep) {
        // FLAG: MAKE POST BEGIN
        data.push_back(std::make_shared<PostSurferUs0O1Surftimeprefactor1O25Pos<TypeObjectStep>>(sObjectStep));
        // FLAG: MAKE POST END
    }
};
