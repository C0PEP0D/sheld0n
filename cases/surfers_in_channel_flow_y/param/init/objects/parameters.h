...
#include "param/init/objects/surfer__us_0o05__surftimeconst_0o25/parameters.h"
#include "param/init/objects/surfer__us_0o05__surftimeconst_0o5/parameters.h"
#include "param/init/objects/surfer__us_0o05__surftimeconst_0o75/parameters.h"
#include "param/init/objects/surfer__us_0o05__surftimeconst_1o25/parameters.h"
#include "param/init/objects/surfer__us_0o05__surftimeconst_1o5/parameters.h"
#include "param/init/objects/surfer__us_0o05__surftimeconst_1o75/parameters.h"
#include "param/init/objects/surfer__us_0o05__surftimeconst_2o0/parameters.h"
#include "param/init/objects/surfer__us_0o05__surftimeconst_2o25/parameters.h"
#include "param/init/objects/surfer__us_0o05__surftimeconst_2o5/parameters.h"
#include "param/init/objects/surfer__us_0o05__surftimeconst_2o75/parameters.h"
...
#include "param/init/objects/surfer__us_0o1__surftimeconst_0o25/parameters.h"
#include "param/init/objects/surfer__us_0o1__surftimeconst_0o5/parameters.h"
#include "param/init/objects/surfer__us_0o1__surftimeconst_0o75/parameters.h"
#include "param/init/objects/surfer__us_0o1__surftimeconst_1o25/parameters.h"
#include "param/init/objects/surfer__us_0o1__surftimeconst_1o5/parameters.h"
#include "param/init/objects/surfer__us_0o1__surftimeconst_1o75/parameters.h"
#include "param/init/objects/surfer__us_0o1__surftimeconst_2o0/parameters.h"
#include "param/init/objects/surfer__us_0o1__surftimeconst_2o25/parameters.h"
#include "param/init/objects/surfer__us_0o1__surftimeconst_2o5/parameters.h"
#include "param/init/objects/surfer__us_0o1__surftimeconst_2o75/parameters.h"
...
#include "param/init/objects/surfer__us_0o2__surftimeconst_0o25/parameters.h"
#include "param/init/objects/surfer__us_0o2__surftimeconst_0o5/parameters.h"
#include "param/init/objects/surfer__us_0o2__surftimeconst_0o75/parameters.h"
#include "param/init/objects/surfer__us_0o2__surftimeconst_1o25/parameters.h"
#include "param/init/objects/surfer__us_0o2__surftimeconst_1o5/parameters.h"
#include "param/init/objects/surfer__us_0o2__surftimeconst_1o75/parameters.h"
#include "param/init/objects/surfer__us_0o2__surftimeconst_2o0/parameters.h"
#include "param/init/objects/surfer__us_0o2__surftimeconst_2o25/parameters.h"
#include "param/init/objects/surfer__us_0o2__surftimeconst_2o5/parameters.h"
#include "param/init/objects/surfer__us_0o2__surftimeconst_2o75/parameters.h"
...
#include "param/init/objects/surfer__us_0o4__surftimeconst_0o25/parameters.h"
#include "param/init/objects/surfer__us_0o4__surftimeconst_0o5/parameters.h"
#include "param/init/objects/surfer__us_0o4__surftimeconst_0o75/parameters.h"
#include "param/init/objects/surfer__us_0o4__surftimeconst_1o25/parameters.h"
#include "param/init/objects/surfer__us_0o4__surftimeconst_1o5/parameters.h"
#include "param/init/objects/surfer__us_0o4__surftimeconst_1o75/parameters.h"
#include "param/init/objects/surfer__us_0o4__surftimeconst_2o0/parameters.h"
#include "param/init/objects/surfer__us_0o4__surftimeconst_2o25/parameters.h"
#include "param/init/objects/surfer__us_0o4__surftimeconst_2o5/parameters.h"
#include "param/init/objects/surfer__us_0o4__surftimeconst_2o75/parameters.h"
...
#include "param/init/objects/surfer__us_0o8__surftimeconst_0o25/parameters.h"
#include "param/init/objects/surfer__us_0o8__surftimeconst_0o5/parameters.h"
#include "param/init/objects/surfer__us_0o8__surftimeconst_0o75/parameters.h"
#include "param/init/objects/surfer__us_0o8__surftimeconst_1o25/parameters.h"
#include "param/init/objects/surfer__us_0o8__surftimeconst_1o5/parameters.h"
#include "param/init/objects/surfer__us_0o8__surftimeconst_1o75/parameters.h"
#include "param/init/objects/surfer__us_0o8__surftimeconst_2o0/parameters.h"
#include "param/init/objects/surfer__us_0o8__surftimeconst_2o25/parameters.h"
#include "param/init/objects/surfer__us_0o8__surftimeconst_2o5/parameters.h"
#include "param/init/objects/surfer__us_0o8__surftimeconst_2o75/parameters.h"
...
struct InitObjectsParameters {
	...
	InitObjectsParameters(std::shared_ptr<TypeObjectsParameters> sObjectsParameters) {
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O05Surftimeconst0O25Parameters, SurferUs0O05Surftimeconst0O25Step>>(sObjectsParameters->sSurferUs0O05Surftimeconst0O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O05Surftimeconst0O75Parameters, SurferUs0O05Surftimeconst0O75Step>>(sObjectsParameters->sSurferUs0O05Surftimeconst0O75Step));
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O05Surftimeconst1O25Parameters, SurferUs0O05Surftimeconst1O25Step>>(sObjectsParameters->sSurferUs0O05Surftimeconst1O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O05Surftimeconst1O75Parameters, SurferUs0O05Surftimeconst1O75Step>>(sObjectsParameters->sSurferUs0O05Surftimeconst1O75Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O05Surftimeconst2O25Parameters, SurferUs0O05Surftimeconst2O25Step>>(sObjectsParameters->sSurferUs0O05Surftimeconst2O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O05Surftimeconst2O75Parameters, SurferUs0O05Surftimeconst2O75Step>>(sObjectsParameters->sSurferUs0O05Surftimeconst2O75Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O1Surftimeconst0O25Parameters, SurferUs0O1Surftimeconst0O25Step>>(sObjectsParameters->sSurferUs0O1Surftimeconst0O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O1Surftimeconst0O75Parameters, SurferUs0O1Surftimeconst0O75Step>>(sObjectsParameters->sSurferUs0O1Surftimeconst0O75Step));
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O1Surftimeconst1O25Parameters, SurferUs0O1Surftimeconst1O25Step>>(sObjectsParameters->sSurferUs0O1Surftimeconst1O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O1Surftimeconst1O75Parameters, SurferUs0O1Surftimeconst1O75Step>>(sObjectsParameters->sSurferUs0O1Surftimeconst1O75Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O1Surftimeconst2O25Parameters, SurferUs0O1Surftimeconst2O25Step>>(sObjectsParameters->sSurferUs0O1Surftimeconst2O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O1Surftimeconst2O75Parameters, SurferUs0O1Surftimeconst2O75Step>>(sObjectsParameters->sSurferUs0O1Surftimeconst2O75Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O2Surftimeconst0O25Parameters, SurferUs0O2Surftimeconst0O25Step>>(sObjectsParameters->sSurferUs0O2Surftimeconst0O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O2Surftimeconst0O75Parameters, SurferUs0O2Surftimeconst0O75Step>>(sObjectsParameters->sSurferUs0O2Surftimeconst0O75Step));
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O2Surftimeconst1O25Parameters, SurferUs0O2Surftimeconst1O25Step>>(sObjectsParameters->sSurferUs0O2Surftimeconst1O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O2Surftimeconst1O75Parameters, SurferUs0O2Surftimeconst1O75Step>>(sObjectsParameters->sSurferUs0O2Surftimeconst1O75Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O2Surftimeconst2O25Parameters, SurferUs0O2Surftimeconst2O25Step>>(sObjectsParameters->sSurferUs0O2Surftimeconst2O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O2Surftimeconst2O75Parameters, SurferUs0O2Surftimeconst2O75Step>>(sObjectsParameters->sSurferUs0O2Surftimeconst2O75Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O4Surftimeconst0O25Parameters, SurferUs0O4Surftimeconst0O25Step>>(sObjectsParameters->sSurferUs0O4Surftimeconst0O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O4Surftimeconst0O75Parameters, SurferUs0O4Surftimeconst0O75Step>>(sObjectsParameters->sSurferUs0O4Surftimeconst0O75Step));
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O4Surftimeconst1O25Parameters, SurferUs0O4Surftimeconst1O25Step>>(sObjectsParameters->sSurferUs0O4Surftimeconst1O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O4Surftimeconst1O75Parameters, SurferUs0O4Surftimeconst1O75Step>>(sObjectsParameters->sSurferUs0O4Surftimeconst1O75Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O4Surftimeconst2O25Parameters, SurferUs0O4Surftimeconst2O25Step>>(sObjectsParameters->sSurferUs0O4Surftimeconst2O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O4Surftimeconst2O75Parameters, SurferUs0O4Surftimeconst2O75Step>>(sObjectsParameters->sSurferUs0O4Surftimeconst2O75Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O8Surftimeconst0O25Parameters, SurferUs0O8Surftimeconst0O25Step>>(sObjectsParameters->sSurferUs0O8Surftimeconst0O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O8Surftimeconst0O75Parameters, SurferUs0O8Surftimeconst0O75Step>>(sObjectsParameters->sSurferUs0O8Surftimeconst0O75Step));
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O8Surftimeconst1O25Parameters, SurferUs0O8Surftimeconst1O25Step>>(sObjectsParameters->sSurferUs0O8Surftimeconst1O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O8Surftimeconst1O75Parameters, SurferUs0O8Surftimeconst1O75Step>>(sObjectsParameters->sSurferUs0O8Surftimeconst1O75Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O8Surftimeconst2O25Parameters, SurferUs0O8Surftimeconst2O25Step>>(sObjectsParameters->sSurferUs0O8Surftimeconst2O25Step));
		...
		sInitsStatic.push_back(std::make_shared<InitInitStatic<InitSurferUs0O8Surftimeconst2O75Parameters, SurferUs0O8Surftimeconst2O75Step>>(sObjectsParameters->sSurferUs0O8Surftimeconst2O75Step));
