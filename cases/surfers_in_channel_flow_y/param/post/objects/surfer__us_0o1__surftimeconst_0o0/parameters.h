...
#include "param/post/objects/surfer__us_0o1__surftimeconst_0o0/pos/choice.h"
...
struct PostSurferUs0O1Surftimeconst0O0Parameters {
    ...
    PostSurferUs0O1Surftimeconst0O0Parameters(std::shared_ptr<TypeObjectStep> sObjectStep) {
        // FLAG: MAKE POST BEGIN
        data.push_back(std::make_shared<PostSurferUs0O1Surftimeconst0O0Pos<TypeObjectStep>>(sObjectStep));
        // FLAG: MAKE POST END
    }
};
