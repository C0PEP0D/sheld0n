...
#include "param/post/objects/surfer__us_15o58__surftimeconst_4o0__reorientationtime_0o5/pos/choice.h"
...
struct PostSurferUs15O58Surftimeconst4O0Reorientationtime0O5Parameters {
    ...
    PostSurferUs15O58Surftimeconst4O0Reorientationtime0O5Parameters(std::shared_ptr<TypeObjectStep> sObjectStep) {
        // FLAG: MAKE POST BEGIN
        data.push_back(std::make_shared<PostSurferUs15O58Surftimeconst4O0Reorientationtime0O5Pos<TypeObjectStep>>(sObjectStep));
        // FLAG: MAKE POST END
    }
};
