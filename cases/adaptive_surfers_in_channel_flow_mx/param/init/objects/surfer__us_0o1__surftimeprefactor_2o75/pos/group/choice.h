...
namespace c0p {
    ...
    using InitSurferUs0O1Surftimeprefactor2O75PosGroup = InitInitGroupAll<InitSurferUs0O1Surftimeprefactor2O75PosGroupAllParameters, TypeObjectStep, InitSurferUs0O1Surftimeprefactor2O75PosGroupMember>;
}
